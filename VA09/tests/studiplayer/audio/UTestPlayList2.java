...
public class UTestPlayList2 {
    ...
    @Test
    public void test_sort_2_TaggedFiles_01() throws Exception{
        PlayList pl1 = new PlayList();
        pl1.add(new TaggedFile("audiofiles/Rock 812.mp3"));
        pl1.add(new TaggedFile("audiofiles/wellenmeister - fire.mp3"));
        pl1.sort(SortCriterion.DURATION);

        String exp[] = new String[]{
                "Wellenmeister - TANOM Part III: Fire - TheAbsoluteNecessityOfMeaning - 03:41",
                "Eisbach - Rock 812 - The Sea, the Sky - 05:31",
        };
